...
public class ChatroomResource {
   private static final Logger log = LoggerFactory.getLogger(ConfigUtils.getLoggerName(ChatroomResource.class));
   private static final Logger setMultiIDSettingsLog = LoggerFactory.getLogger("SetMultiIDSettingsLog");
