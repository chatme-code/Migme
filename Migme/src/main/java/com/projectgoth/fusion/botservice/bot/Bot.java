...
public abstract class Bot {
   private static final Logger log = LoggerFactory.getLogger(ConfigUtils.getLoggerName(Bot.class));
   private static final Logger logMetrics = LoggerFactory.getLogger("gamesBotMetricsLog");
