...
public class Werewolf extends Bot {
   static final Logger log = LoggerFactory.getLogger(ConfigUtils.getLoggerName(Werewolf.class));
   List<String> players;
   ...
   protected void setRoles() {
      if (this.players.size() < 5) {
         ...
         for(int i2 = 0; i2 < this.players.size(); ++i2) {
            ...
            if (!this.wolf[i2] && i2 != this.seer) {
               this.sendMessage(this.createMessage("VILLAGER-ROLE", (String)this.players.get(i2)), (String)this.players.get(i2));
            }
         }
