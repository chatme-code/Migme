...
public class Vampire extends Bot {
   static final Logger log = LoggerFactory.getLogger(ConfigUtils.getLoggerName(Vampire.class));
   List<String> players;
   ...
   protected void setRoles() {
      if (this.players.size() < 5) {
         ...
         for(int i2 = 0; i2 < this.players.size(); ++i2) {
            ...
            if (!this.vampire[i2] && i2 != this.slayer) {
               this.sendMessage(this.createMessage("EXPLORER-ROLE", (String)this.players.get(i2)), (String)this.players.get(i2));
            }
         }
