...
public class AuthenticationService extends Application {
   private static Logger log = LoggerFactory.getLogger(ConfigUtils.getLoggerName(AuthenticationService.class));
   ...
   public int run(String[] arg0) {
      ...
      try {
         ...
         if (interrupted()) {
            log.error("AuthenticationService " + this.hostName + ": terminating");
