...
public class AuthenticationServiceI extends _AuthenticationServiceDisp implements InitializingBean {
   private static final Logger log = LoggerFactory.getLogger(ConfigUtils.getLoggerName(AuthenticationServiceI.class));
   private static final Logger authenticationLog = LoggerFactory.getLogger("AuthenticationLog");
