...
public class DBUtils {
   private static final Logger log = LoggerFactory.getLogger(ConfigUtils.getLoggerName(DBUtils.class));
   ...
   public static enum DataSourceEnum {
      ...
      private DataSourceEnum(FusionConfigEnum configEnum) {
         this.driverClass = (new FusionStringConfigurationValue(configEnum, "c3p0.driverClass", "com.mysql.cj.jdbc.Driver")).get();
