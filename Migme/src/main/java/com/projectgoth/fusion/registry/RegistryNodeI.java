...
public class RegistryNodeI extends _RegistryNodeDisp {
   private static Logger log = LoggerFactory.getLogger(ConfigUtils.getLoggerName(RegistryNodeI.class));
            ...
            if (otherRegistryNodePrx != null) {
               if (!connectedToFirstNode) {
                  ...
                  try {
                     ...
                     log.error("Registry " + this.applicationContext.getHostName() + ": Replication from Registry on " + otherRegistryHostName + " failed. Exception: " + var9.message);
                     throw new Exception();
                  }
