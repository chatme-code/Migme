...
public class MSNObject {
   ...
   public MSNObject(String creator, String friendlyName, MSNObject.Type type, String fileLocation) throws IOException, NoSuchAlgorithmException {
      ...
      in.close();
      this.sha1d = encoder.encodeToString(messageDigest.digest(this.fileContent));
      this.sha1c = encoder.encodeToString(messageDigest.digest(this.getChecksumContent().getBytes()));
   }
