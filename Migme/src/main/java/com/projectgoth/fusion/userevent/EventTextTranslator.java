...
public class EventTextTranslator {
   private static final Logger log = LoggerFactory.getLogger(ConfigUtils.getLoggerName(EventTextTranslator.class));
   ...
   private static boolean loadProperties() {
      ...
      try {
         ...
         log.error("Failed to load translation.properties, it should be at [" + propertiesLocation + "], aborting.", var2);
      }
