...
public class DumpGeneratorEvents {
   private Logger log = LoggerFactory.getLogger(ConfigUtils.getLoggerName(DumpGeneratorEvents.class));
   ...
   private void setup(File environmentHome) {
      try {
         ...
         this.log.error("Error opening environment and store, exiting... ", var4);
      }
   ...
   public void closeDb() {
      ...
      if (this.environment != null) {
         try {
            ...
            this.log.error("Error closing Environment, exiting... ", var2);
            return;
         }
      }
