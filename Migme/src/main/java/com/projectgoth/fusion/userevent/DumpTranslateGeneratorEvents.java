...
public class DumpTranslateGeneratorEvents {
   private static Logger log = LoggerFactory.getLogger(ConfigUtils.getLoggerName(DumpTranslateGeneratorEvents.class));
   ...
   private void setup(File environmentHome) {
      try {
         ...
         log.error("Error opening environment and store, exiting... ", var4);
      }
