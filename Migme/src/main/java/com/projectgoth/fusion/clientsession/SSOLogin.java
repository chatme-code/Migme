...
public class SSOLogin {
   private static Logger log = LoggerFactory.getLogger(ConfigUtils.getLoggerName(SSOLogin.class));
   private static final Logger vasLog = LoggerFactory.getLogger("vaslog");
