...
public class Membase {
   private static final Logger log = LoggerFactory.getLogger(ConfigUtils.getLoggerName(Membase.class));
   ...
   private static boolean loadProperties() {
      ...
      try {
         ...
         log.error("Failed to load membase.properties, it should be at [" + propertiesLocation + "], aborting.", var2);
      }
   ...
   static {
      ...
      if (loadProperties()) {
         try {
            ...
            log.error("Unable to initialize Membase", var3);
         }
      }
