...
public class FusionPktOpenURL extends FusionRequest {
   ...
   private static Logger log = LoggerFactory.getLogger(ConfigUtils.getLoggerName(FusionPktOpenURL.class));
   private static final Logger auditLog = LoggerFactory.getLogger("HttpTunnelAudit");
