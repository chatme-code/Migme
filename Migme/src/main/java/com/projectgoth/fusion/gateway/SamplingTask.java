...
public class SamplingTask implements Runnable {
   ...
   private static Logger log = LoggerFactory.getLogger(ConfigUtils.getLoggerName(Gateway.class));
      ...
      label110: {
         try {
            ...
            if (!logSummary) {
               ...
               out = new FileOutputStream(this.summaryFile + this.fileDateFormat.format(new Date()), true);
