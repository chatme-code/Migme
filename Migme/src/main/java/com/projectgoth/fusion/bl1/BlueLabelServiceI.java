...
public class BlueLabelServiceI extends _BlueLabelServiceDisp {
   private static final Logger log = LoggerFactory.getLogger(ConfigUtils.getLoggerName(BlueLabelServiceI.class));
   ...
   public class UpdateWebserviceKeyThread extends TimerTask {
      ...
      public void run() {
         try {
            ...
            BlueLabelServiceI.log.error("failed to update web service key!!!");
         }
