...
public class BlueLabelService extends Application {
   private static Logger log = LoggerFactory.getLogger(ConfigUtils.getLoggerName(BlueLabelService.class));
   ...
   public int run(String[] arg0) {
      ...
      try {
         ...
         log.error("failed to configure bluelabel service servant", var5);
      ...
      if (interrupted()) {
         log.error("BlueLabelService " + this.hostName + ": terminating");
