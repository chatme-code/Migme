...
public class BotHunter {
   private static final Logger log = LoggerFactory.getLogger(ConfigUtils.getLoggerName(BotHunter.class));
...
//       org.apache.log4j.Logger.getRootLogger().setLevel(Level.INFO); // SLF4J: removed
   }
...
//          org.apache.log4j.Logger.getRootLogger().setLevel(Level.DEBUG); // SLF4J: removed
      }

      Logger kickLogger;
      if (line.hasOption("VerbosePacketCapture")) {
         kickLogger = LoggerFactory.getLogger(ConfigUtils.getLoggerName(MonitorThread.class));
//          kickLogger.setLevel(Level.DEBUG); // SLF4J: removed
      }

      if (line.hasOption("VerboseAnalysis")) {
         kickLogger = LoggerFactory.getLogger(ConfigUtils.getLoggerName(AnalysisThread.class));
//          kickLogger.setLevel(Level.DEBUG); // SLF4J: removed
      }

      if (line.hasOption("VerboseKick")) {
         kickLogger = LoggerFactory.getLogger(ConfigUtils.getLoggerName(KickThread.class));
//          kickLogger.setLevel(Level.DEBUG); // SLF4J: removed
      }
