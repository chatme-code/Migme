...
public class BotKickerIce extends Application {
   private static final Logger log = LoggerFactory.getLogger(ConfigUtils.getLoggerName(KickThread.class));
   ...
   public int run(String[] args) {
      try {
         ...
         log.error("BotKickerIce starting with logging level " + "(level-not-available)");
...
//          log.setLevel(Level.DEBUG); // SLF4J: removed
      }
