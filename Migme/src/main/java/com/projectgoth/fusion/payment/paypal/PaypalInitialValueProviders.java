...
public class PaypalInitialValueProviders {
   ...
   public static class AllCountPerPaypalUser extends PaypalInitialValueProvider<String> {
      ...
      private static final Logger LOG = LoggerFactory.getLogger(ConfigUtils.getLoggerName(PaypalInitialValueProviders.AllValuePerCountry.class));
   ...
   public static class AllCountPerCountry extends PaypalInitialValueProvider<PaypalInitialValueProviders.AllCountPerCountry.Param> {
      ...
      private static final Logger LOG = LoggerFactory.getLogger(ConfigUtils.getLoggerName(PaypalInitialValueProviders.AllCountPerCountry.class));
   ...
   public static class AllValuePerUserType extends PaypalInitialValueProvider<UserData.TypeEnum> {
      ...
      private static final Logger LOG = LoggerFactory.getLogger(ConfigUtils.getLoggerName(PaypalInitialValueProviders.AllValuePerUserType.class));
   ...
   public static class AllCountPerUserType extends PaypalInitialValueProvider<UserData.TypeEnum> {
      ...
      private static final Logger LOG = LoggerFactory.getLogger(ConfigUtils.getLoggerName(PaypalInitialValueProviders.AllCountPerUserType.class));
   ...
   public static class AllValuePerUserID extends PaypalInitialValueProvider<Integer> {
      ...
      private static final Logger LOG = LoggerFactory.getLogger(ConfigUtils.getLoggerName(PaypalInitialValueProviders.AllValuePerUserID.class));
   ...
   public static class AllCountPerUserID extends PaypalInitialValueProvider<Integer> {
      ...
      private static final Logger LOG = LoggerFactory.getLogger(ConfigUtils.getLoggerName(PaypalInitialValueProviders.AllCountPerUserID.class));
