...
public abstract class ChatRoomNewsFeedApp extends Application {
   ...
   public int run(String[] arg0) {
      ...
      try {
         ...
         logger.error("Chat Room NewsFeed: " + hostName + ": Connection to [" + registryPrx + "] failed. ", var5);
         return 1;
      }

      if (registryPrx == null) {
         logger.error("Chat Room NewsFeed: " + hostName + ": Connection to [" + registryPrx + "] failed");
         return 1;
      } else {
         return 0;
      }
