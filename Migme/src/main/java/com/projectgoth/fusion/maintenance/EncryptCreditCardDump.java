...
public class EncryptCreditCardDump {
   protected static Logger log = LoggerFactory.getLogger(ConfigUtils.getLoggerName(EncryptCreditCardDump.class));
   ...
   public void start() throws SQLException, Exception {
      ...
      if (publicKey == null) {
         log.error("loaded public key from [" + CreditCardUtils.PUBLIC_KEY_LOCATION + "] is null!");
         System.exit(1);
      }
