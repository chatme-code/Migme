...
public class ChatUser implements ChatSourceUser, ChatConnectionListenerInterface {
   ...
   private static final Logger log = LoggerFactory.getLogger(ConfigUtils.getLoggerName(ChatUser.class));
   private static final Logger floodLog = LoggerFactory.getLogger("FloodLogAudit");
