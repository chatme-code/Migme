...
public class RedisChatSyncPipelineStore extends RedisChatSyncStore {
   ...
   static {
      log = new LogFilter(LoggerFactory.getLogger(ConfigUtils.getLoggerName(RedisChatSyncPipelineStore.class)), SystemPropertyEntities.ChatSyncSettings.LOG_EXCLUSION_FILTER);
   }
}
