...
public class ServerGeneratedReceivedEventPusher extends MessageStatusEventPersistable {
   ...
   static {
      log = new LogFilter(LoggerFactory.getLogger(ConfigUtils.getLoggerName(ServerGeneratedReceivedEventPusher.class)), SystemPropertyEntities.ChatSyncSettings.LOG_EXCLUSION_FILTER);
   }
}
