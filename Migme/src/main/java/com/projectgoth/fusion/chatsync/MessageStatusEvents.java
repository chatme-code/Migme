...
public class MessageStatusEvents implements ChatSyncEntity {
   ...
   static {
      log = new LogFilter(LoggerFactory.getLogger(ConfigUtils.getLoggerName(MessageStatusEvents.class)), SystemPropertyEntities.ChatSyncSettings.LOG_EXCLUSION_FILTER);
   }
