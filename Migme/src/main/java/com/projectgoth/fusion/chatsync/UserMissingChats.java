...
public class UserMissingChats extends UserChatLists {
   ...
   static {
      log = new LogFilter(LoggerFactory.getLogger(ConfigUtils.getLoggerName(UserMissingChats.class)), SystemPropertyEntities.ChatSyncSettings.LOG_EXCLUSION_FILTER);
   }
}
