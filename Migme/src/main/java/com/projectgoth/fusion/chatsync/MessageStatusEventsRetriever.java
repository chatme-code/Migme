...
public class MessageStatusEventsRetriever extends MessageStatusEvents {
   ...
   static {
      log = new LogFilter(LoggerFactory.getLogger(ConfigUtils.getLoggerName(MessageStatusEventsRetriever.class)), SystemPropertyEntities.ChatSyncSettings.LOG_EXCLUSION_FILTER);
   }
}
