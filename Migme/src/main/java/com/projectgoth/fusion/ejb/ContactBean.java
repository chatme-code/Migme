...
public class ContactBean implements SessionBean {
   ...
   private static final Logger log = LoggerFactory.getLogger(ConfigUtils.getLoggerName(ContactBean.class));
   private static final Logger contactDeletedLog = LoggerFactory.getLogger("ContactDeletedLog");
