...
public class GiftAllTask implements Runnable {
   private static final Logger log = LoggerFactory.getLogger(ConfigUtils.getLoggerName(GiftAllTask.class));
   private static final Logger metricslog = LoggerFactory.getLogger("GiftAllMetrics");
