...
public class VoiceEngine extends Application {
   ...
   private static final Logger log = LoggerFactory.getLogger(ConfigUtils.getLoggerName(VoiceEngine.class));
   ...
   public int run(String[] arg0) {
      try {
         ...
         log.error("Failed to load voice gateways and calls in progress from database", var13);
      } catch (RemoteException var14) {
         log.error("EJB excepion - " + RMIExceptionHelper.getRootMessage(var14), var14);
      } catch (IOException var15) {
         log.error("IO exception", var15);
      }
