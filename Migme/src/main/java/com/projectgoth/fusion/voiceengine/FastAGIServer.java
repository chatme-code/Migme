...
public class FastAGIServer extends Thread {
   private static final Logger log = LoggerFactory.getLogger(ConfigUtils.getLoggerName(FastAGIServer.class));
      ...
      while(true) {
         try {
            ...
            try {
               ...
               log.error("Failed to restart FastAGI server socket - " + var4.getClass().getName() + ":" + var4.getMessage());
            }
         }
      }
   }
